...
# Common things
include "/etc/varnish/moodle/ext/general/common.vcl";

## Backend tells where a site can be found
backend moodle {					# use your servers instead default if you have more than just one
...
include "/etc/varnish/moodle/sites.vcl";
include "/etc/varnish/moodle/cookies.vcl";