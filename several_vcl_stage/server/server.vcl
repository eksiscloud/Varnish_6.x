## Same as _default in Nginx; handling requests using just IP of the server ##
...
backend default-server {			# use your servers instead default if you have more than just one
	.host = "127.0.0.1";			# IP or Hostname of backend
	.port = "82";					# Apache, Nginx or whatever is listening
...
sub vcl_recv {
	if (req.http.host == "104.248.141.204" || req.http.host == "_" || req.http.host == "") {
		set req.backend_hint = default-server;
	}
