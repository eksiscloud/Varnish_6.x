...
# WooCommerce related
include "/etc/varnish/common/general/woocommerce_common.vcl";

# Common things
include "/etc/varnish/woocommerce/ext/general/common.vcl";

# 410 Gone
include "/etc/varnish/woocommerce/ext/redirect/410sites.vcl";

# 301 Redirect
include "/etc/varnish/woocommerce/ext/redirect/301sites.vcl";

## Backend tells where a site can be found
backend woocommerce {				# use your servers instead default if you have more than just one
...
sub vcl_recv {
	...
	## At this point we jump to vhost.vcl
...
include "/etc/varnish/woocommerce/sites.vcl";
include "/etc/varnish/woocommerce/cookies.vcl";