sub sec_headers {
	...
	if (!resp.http.Content-Security-Policy) {
		...
		set resp.http.x-www-google = "www.google.lv www.google.co.uk www.google.nl www.google.com.au www.google.es www.google.no www.google.se www.google.de www.google.fi www.google.com";
		set resp.http.x-adservice = "adservice.google.lv adservice.google.co.uk adservice.google.com adservice.google.pt adservice.google.com.au adservice.google.nl adservice.google.fi adservice.google.se adservice.google.no adservice.google.it adservice.google.es adservice.google.de";
		# -->
		...
		set resp.http.x-frame-src = "frame-src wp.freemius.com wp-rocket.me js.klarna.com www.facebook.com *.twitter.com *.google.com *.googlesyndication.com *.doubleclick.net *.soundcloud.com *.youtube.com *.vimeo.com 'self' https://*.katiska.info";
		...
		set resp.http.x-media-src = "media-src fast.wistia.net e-matsku.s3-eu-west-1.amazonaws.com s3-eu-west-1.amazonaws.com/e-matsku/ blob: data: 'self'";
		set resp.http.x-font-src = "font-src maxcdn.bootstrapcdn.com l.facebook.com use.fontawesome.com fonts.gstatic.com data: 'self'";
		...
		set resp.http.x-prefetch-src = "prefetch-src 'unsafe-inline' 'self'";
		...
		if (req.url !~ "/embed/" || req.http.host ~ "store.") {
